                    ...
                    <div>
                        <form role="form" method="post" autocomplete="off">
                            ...
                            <div class="inputArea">
                                ...
                                <input type="text" id="user_id" name="user_id" value="${productsViewVo.user_id}"
                                       readonly/>
                            </div>
                            <div class="inputArea">
                            ...
                            <div class="inputArea">
                                ...
                                <textarea rows="5" cols="50" id="description"
                                          name="description">${productsViewVo.description}</textarea>
                            </div>
...
<script>
    ...
    if (msg == "modify_err") {
        alert("상품수정에 실패 하였습니다. 입력값을 확인해 주세요.")
    }
</script>
<script>
    /* 이미지 정보 호출 */
