...
<div class="user-order-list_main">
    <div class="user-order-list_main-outter">
        <h1 class="user-order-detail_main_title">주문 상세</h1>
        <div class="admin_content_wrap">
            <div class="user-order-detail_title">주문 정보 : ${orderInfo.orderId}</div>
            <div class="">
                <table>
                    <tr>
                        <th>상품번호</th>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    (배송비 : <fmt:formatNumber value="${orderInfo.deliveryCost}"
                                                             pattern="###,###,###,### 원"/>)
                                </td>
                            </tr>
                            <tr>
...
<form id="deleteForm" action="/WYW/mypage/orderCancel" method="post">
