...
.title{
  width: 110px;
  height: 23px;
  background: url(${pageContext.request.contextPath}/resources/board_img/title.png) no-repeat center/cover;
}

#box1:hover .box_Shadow,#box2:hover .box_Shadow,#box3:hover .box_Shadow,
#box4:hover .box_Shadow,#box5:hover .box_Shadow,#box6:hover .box_Shadow,
#box7:hover .box_Shadow,#box8:hover .box_Shadow,#box9:hover .box_Shadow,
#box10:hover .box_Shadow,#box11:hover .box_Shadow 
{
  display: block;
  display: flex;
         ...
         <table>
           ...
           <tbody>
                <tr>
                    ...
                    <td id="nav_SUBJECT_Value"><a href="<c:url value="/board/read${ph.sc.queryString}&bno=${boardDto.bno}"/>"><c:out value="${boardDto.title}${boardDto.comment_cnt==0 ? '':[boardDto.comment_cnt]}"/></a></td>
            ...
            <div class="button">
                ...
                <c:if test="${totalCnt!=null && totalCnt!=0}">
                    ...
                    <c:if test="${ph.showNext}">
                        <a id="btn_right" href="<c:url value="/board/list${ph.sc.getQueryString(ph.endPage+1)}"/>"></a>
                    </c:if>
                </c:if>
            </div>
        </div>
