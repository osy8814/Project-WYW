                    ...
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${boardDto.reg_date.time >= startOfToday}">
                                <td class="regdate" id="nav_DATE_Value"><fmt:formatDate value="${boardDto.reg_date}"
                                                                                        pattern="HH:mm"
                                                                                        type="time"/></td>
                            </c:when>
                            <c:otherwise>
            ...
            <div class="button">
                ...
                <c:if test="${totalCnt!=null && totalCnt!=0}">
                    ...
                    <c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
                        <a id="btn_mid" ${i==ph.sc.page? "paging-active" : ""}" href="<c:url
                            value="/board/list${ph.sc.getQueryString(i)}"/>">${i}</a>
                    </c:forEach>
        ...
        <div class="main-page__Bottom">
            ...
            <div class="main-page__Bottom_box">
                <form action="<c:url value="/board/list"/>" class="search-form" method="get">
                    ...
                    <input id="search_input" type="text" name="keyword" class="search-input" type="text"
                           value="${ph.sc.keyword}" placeholder="검색어를 입력해주세요">
                    <button type="submit" class="search-button" value="찾기">찾기</button>
                </form>

                <button id="writeBtn" class="btn-write" onclick="location.href='<c:url value="/board/write"/>'">글쓰기
                </button>
