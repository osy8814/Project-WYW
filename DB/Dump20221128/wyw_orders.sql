...
CREATE TABLE `orders` (
  ...
  `receiver` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `order_state` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
